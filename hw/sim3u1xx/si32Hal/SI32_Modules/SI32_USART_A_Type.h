...
/// @fn _SI32_USART_A_clear_tx_data_request_interrupt(SI32_USART_A_Type* basePointer)
///
/// @param[in]
///  basePointer
///
void
_SI32_USART_A_clear_tx_data_request_interrupt(SI32_USART_A_Type* /*basePointer*/);
///
/// @def SI32_USART_A_clear_tx_data_request_interrupt(basePointer)
#define SI32_USART_A_clear_tx_data_request_interrupt(basePointer) \
   (basePointer->CONTROL_CLR = SI32_USART_A_CONTROL_TDREQI_MASK)
