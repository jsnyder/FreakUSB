...
/// @fn _SI32_EPCA_A_enable_idle_bypass(SI32_EPCA_A_Type* basePointer)
///
/// @param[in]
///  basePointer
///
void
_SI32_EPCA_A_enable_idle_bypass(SI32_EPCA_A_Type* /*basePointer*/);
///
/// @def SI32_EPCA_A_enable_idle_bypass(basePointer)
#define SI32_EPCA_A_enable_idle_bypass(basePointer) \
   (basePointer->CONTROL_SET = SI32_EPCA_A_CONTROL_IDLEBEN_ENABLED_U32)


/// @fn _SI32_EPCA_A_disable_idle_bypass(SI32_EPCA_A_Type* basePointer)
///
/// @param[in]
///  basePointer
///
void
_SI32_EPCA_A_disable_idle_bypass(SI32_EPCA_A_Type* /*basePointer*/);
///
/// @def SI32_EPCA_A_disable_idle_bypass(basePointer)
#define SI32_EPCA_A_disable_idle_bypass(basePointer) \
   (basePointer->CONTROL_CLR = SI32_EPCA_A_CONTROL_IDLEBEN_MASK)
