...
// Set the APB as the input clock (F<subscript>CLKIN</subscript>).
...
// Set Timer 0 low overflows divided by 2 as the input clock
// (F<subscript>CLKIN</subscript>).
...
// Set high-to-low transitions on ECI divided by 2 as the input clock
// (F<subscript>CLKIN</subscript>).
...
// clock (F<subscript>CLKIN</subscript>).
...
// Set ECI transitions divided by 2 as the input clock
// (F<subscript>CLKIN</subscript>).
