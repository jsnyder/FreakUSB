...
// Connects the NMUX signal to CP-, the PMUX signal to the Comparator DAC voltage
// reference, and the DAC output to CP+.
...
// Connects the PMUX signal to CP+, the NMUX signal to the Comparator DAC voltage
// reference, and the DAC output to CP-.
