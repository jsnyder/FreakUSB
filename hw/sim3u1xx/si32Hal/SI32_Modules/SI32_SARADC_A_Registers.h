...
// master ADC (selected by SSGEN) and the lower half-word represents data from the
// slave ADC. The ADC write to the lower half-word will trigger the SCI interrupt,
// if enabled.
...
// master ADC (selected by SSGEN) and the upper half-word represents data from the
// slave ADC. The ADC write to the upper half-word will trigger the SCI interrupt,
// if enabled.
