...
/// @fn _SI32_RTC_A_write_lfoscadj(SI32_RTC_A_Type* basePointer,
///      uint32_t lfoscadj)
///
/// @param[in]
///  basePointer
...
///  lfoscadj
///  Valid range is 32 bits.
///  Write to LFOSCADJ register.
///
void
_SI32_RTC_A_write_lfoscadj(SI32_RTC_A_Type* /*basePointer*/,
   uint32_t /*lfoscadj*/);
///
/// @def SI32_RTC_A_write_lfoscadj(basePointer, lfoscadj)
#define SI32_RTC_A_write_lfoscadj(basePointer, lfoscadj) \
   (basePointer->LFOSCADJ.U32 = lfoscadj)


/// @fn _SI32_RTC_A_read_lfoscadj(SI32_RTC_A_Type* basePointer)
///
/// @return
///  Read LFOSCADJ register.
///
/// @param[in]
///  basePointer
///
uint32_t
_SI32_RTC_A_read_lfoscadj(SI32_RTC_A_Type* /*basePointer*/);
///
/// @def SI32_RTC_A_read_lfoscadj(basePointer)
#define SI32_RTC_A_read_lfoscadj(basePointer) \
(basePointer->LFOSCADJ.U32)
