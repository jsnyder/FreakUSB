...
struct SI32_RTC_A_LFOSCADJ_Struct
{
   union
   {
      struct
      {
         ...
         volatile uint32_t LFOSCADJ_BITS: 4;
...
#define SI32_RTC_A_LFOSCADJ_LFOSCADJ_MASK  0x0000000F
#define SI32_RTC_A_LFOSCADJ_LFOSCADJ_SHIFT  0
...
typedef struct SI32_RTC_A_Struct
{
   ...
   struct SI32_RTC_A_LFOSCADJ_Struct               LFOSCADJ       ; // Base Address + 0x80
   uint32_t                                        reserved18;
   uint32_t                                        reserved19;
   uint32_t                                        reserved20;
} SI32_RTC_A_Type;
