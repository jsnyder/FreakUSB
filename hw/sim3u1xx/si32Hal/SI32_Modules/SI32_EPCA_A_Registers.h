...
#define SI32_EPCA_A_CONTROL_IDLEBEN_MASK  0x00000020
#define SI32_EPCA_A_CONTROL_IDLEBEN_SHIFT  5
// The EPCA module will stop running when the core halts (idle).
#define SI32_EPCA_A_CONTROL_IDLEBEN_DISABLED_VALUE  0
#define SI32_EPCA_A_CONTROL_IDLEBEN_DISABLED_U32 \
   (SI32_EPCA_A_CONTROL_IDLEBEN_DISABLED_VALUE << SI32_EPCA_A_CONTROL_IDLEBEN_SHIFT)
// The EPCA module will continue normal operation when the core halts (idle).
#define SI32_EPCA_A_CONTROL_IDLEBEN_ENABLED_VALUE  1
#define SI32_EPCA_A_CONTROL_IDLEBEN_ENABLED_U32 \
   (SI32_EPCA_A_CONTROL_IDLEBEN_ENABLED_VALUE << SI32_EPCA_A_CONTROL_IDLEBEN_SHIFT)
...
// Select input trigger 0, EPCAnT0.
...
// Select input trigger 1, EPCAnT1.
...
// Select input trigger 2,  EPCAnT2.
...
// Select input trigger 3, EPCAnT3.
