...
///
/// @brief
/// Configures the reset time. A longer reset to adds some additional
/// noise immunity, but causes measurements to take more time.
///
/// @param[in]
///  basePointer
///
...
///  reset
///  Valid range is 2 bits.
///  Reset value of 0 = no additional time is used for second reset, 1 = an
///  additional 0.75 us delay is added to second reset, 2 = an additional
///  1.5 us delay is added to second reset, 3 = an additional 2.25 us delay
///  is added to second reset.
///
void
...
#define SI32_CAPSENSE_A_set_double_reset(basePointer, reset) do{  \
   basePointer->MODE_CLR = SI32_CAPSENSE_A_MODE_DRSEL_MASK;\
   basePointer->MODE_SET = reset << SI32_CAPSENSE_A_MODE_DRSEL_SHIFT;\
} while(0)
...
///
/// @brief
/// These bits set the internal corner frequency of the capsense low-pass
/// filter. Higher values of CSLP result in a lower internal corner
/// frequency. For most touch-sensitive switches, the default setting of
/// 000b should be used.
///
/// @param[in]
///  basePointer
...
///  filter
///  Valid range is 3 bits.
///  If the filter value is adjusted from its default value, filter should
///  normally be set to 1. Settings higher than 1 will result in attenuated
///  readings from the capsense module and should be used only under
///  special circumstances. See the datasheet for more information.
///
void
...
#define SI32_CAPSENSE_A_set_low_pass_filter_corner_frequency(basePointer, filter) do{  \
   basePointer->MODE_CLR = SI32_CAPSENSE_A_MODE_LPFSEL_MASK;\
   basePointer->MODE_SET = filter << SI32_CAPSENSE_A_MODE_LPFSEL_SHIFT;\
} while(0)
